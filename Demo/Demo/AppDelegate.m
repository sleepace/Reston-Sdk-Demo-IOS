...
//  Demo
//
//  Created by medica_mac on 15-3-4.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *iNav = [[UINavigationController alloc]initWithRootViewController:self.rootVC];
    iNav.navigationBarHidden = YES;
